...
class PosRot {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float64(obj.rot_w, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.rot_w = _deserializer.float64(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return '90f86f8fc92c2d6e2f02c50d83b3e47c';
  }
